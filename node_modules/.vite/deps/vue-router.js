...
var NavigationDuplicated = function(Error2) {
  function NavigationDuplicated2(normalizedLocation) {
    Error2.call(this);
    this.name = this._name = "NavigationDuplicated";
    this.message = 'Navigating to current location ("' + normalizedLocation.fullPath + '") is not allowed';
    Object.defineProperty(this, "stack", {
      value: new Error2().stack,
      writable: true,
      configurable: true
    });
  }
  if (Error2)
    NavigationDuplicated2.__proto__ = Error2;
  NavigationDuplicated2.prototype = Object.create(Error2 && Error2.prototype);
  NavigationDuplicated2.prototype.constructor = NavigationDuplicated2;
  return NavigationDuplicated2;
}(Error);
